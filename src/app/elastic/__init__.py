...
These building blocks are used in the `collections`, `learning_material` and `stats` modules to build concrete
queries against the elasticsearch index. They are also used in some other places across the application.
